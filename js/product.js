...
async function showPromotion(){
  ...
  showSauriengtuoi(products);
  showSauriengdonglanh(products);
  showSauriengsay(products);
  showCombosaurieng(products);
}

function showSauriengtuoi(products){
  let sauriengtuois = products.filter((product) => {
    return product.category == '6'
  });
  sauriengtuois = sauriengtuois.slice(0, 3);
	var item = sauriengtuois.map(item => {
			return `<div class="item">
            <div class="product-item">
  ...
  var product = item.join('');
  $('#sauriengtuoi .container').innerHTML = product;
}

function showSauriengdonglanh(products){
  let sauriengdonglanhs = products.filter((product) => {
    return product.category == '2'
  });
  sauriengdonglanhs = sauriengdonglanhs.slice(0, 3);
	var item = sauriengdonglanhs.map(item => {
			return `<div class="item">
            <div class="product-item">
                 <div class="tag" style="display: none;">${item.tag}</div>
                 <div class="thumb"><img src="${item.image}" alt=""></div>
  ...
  var product = item.join('');
  $('#sauriengdonglanh .container').innerHTML = product;
}

function showSauriengsay(products){
  let sauriengsays = products.filter((product) => {
    return product.category == '7'
  });
  sauriengsays = sauriengsays.slice(0, 3);
	var item = sauriengsays.map(item => {
			return `<div class="item">
            <div class="product-item">
                 <div class="tag" style="display: none;">${item.tag}</div>
                 <div class="thumb"><img src="${item.image}" alt=""></div>
  ...
  var product = item.join('');
  $('#sauriengsay .container').innerHTML = product;
}

function showCombosaurieng(products){
  let combosauriengs = combosauriengs.filter((product) => {
    return product.category == '8'
  });
  combosauriengs = combosauriengs.slice(0, 3);
	var item = combosauriengs.map(item => {
			return `<div class="item">
            <div class="product-item">
                 <div class="tag" style="display: none;">${item.tag}</div>
                 <div class="thumb"><img src="${item.image}" alt=""></div>
  ...
  var product = item.join('');
  $('#combosaurieng .container').innerHTML = product;
}
...
function navigateFilter(){
  ...
  switch (urlParams){
    ...
    case '#offer':
      ...
      break;
    case '#sauriengtuoi':
      $('#sauriengtuoi').classList.add('active');
      showSauriengtuoiFilter();
      break;
    case '#sauriengdonglanh':
      $('#sauriengdonglanh').classList.add('active');
      showSauriengdonglanhFilter();
      break;
    case '#sauriengsay':
      $('#sauriengsay').classList.add('active');
      showSauriengsayFilter();
      break;
    case '#combosaurieng':
      $('#combosaurieng').classList.add('active');
      showCombosauriengFilter();
      break;
  }
...
async function showSauriengtuoiFilter(){
  const products = await getProducts();
  let sauriengtuois = products.filter((product) => {
    return product.category == '6'
  });
...
async function showSauriengdonglanhFilter(){
  const products = await getProducts();
  let sauriengdonglanhs = products.filter((product) => {
    return product.category == '2'
  });
...
async function showSauriengsayFilter(){
  const products = await getProducts();
  let sauriengsays = products.filter((product) => {
    return product.category == '7'
  });
...
async function showCombosauriengFilter(){
  const products = await getProducts();
  let combosauriengs = products.filter((product) => {
    return product.category == '8'
  });
	var item = combosauriengs.map(item => {
			return `<div class="item">
